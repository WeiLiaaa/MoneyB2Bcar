...
import com.liwei.moneyb2bcar.fragment.cartactivity.GroupInfo;
import com.liwei.moneyb2bcar.fragment.cartactivity.ProductInfo;
import com.liwei.moneyb2bcar.fragment.cartactivity.ShopCarExpandableListviewAdapter;
...
public class FragmentCart extends Fragment implements ShopCarExpandableListviewAdapter.
        CheckInterface, ShopCarExpandableListviewAdapter.ModifyCountInterface,
    ...
    private void virtualData() {
        ...
        for (int i = 0; i < 6; i++) {
            ...
            groups.add(new GroupInfo(i + "", "华佗医药" ));

...
public class HomeADVAdapter2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private final Context context;
    private final List<ADCBean.DatasBean.GoodsBean.ItemBean> item;
    private MyRecyclerViewItemLongClickListener listener;

    public HomeADVAdapter2(Context context, List<ADCBean.DatasBean.GoodsBean.ItemBean> item) {
